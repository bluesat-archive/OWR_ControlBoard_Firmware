...
void __attribute__((__interrupt__, no_auto_psv)) _IC1Interrupt(void) {
    ...
    timePeriod1 = (PR5 * enc0) + t2 - t1; // Calculate time perioid between pulses(part of todo, need to check this with timer period etc)
